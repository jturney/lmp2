...
public: 
    ...
    */
    Local(boost::shared_ptr<Wavefunction> wavefunction);
    /*!
    * Constructor, builds a Local object with a reference to basisset and C
    ...
    * then call Local::localize() 
    */
    Local(boost::shared_ptr<Wavefunction> wavefunction, boost::shared_ptr<BasisSet> auxiliary);
    virtual ~Local();    
